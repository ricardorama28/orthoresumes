...
Prompt para generar la versión **premium** (hecha a mano) del HTML de un tema, más allá de la línea base determinística que produce `node engine/build.js <ID> --html`. Ver también la skill `html-interactivo`.
